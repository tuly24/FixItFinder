...
app.get('/top-technicians', async (req, res) => {
  try {
...
app.get('/technicians/count-by-profession', async (req, res) => {
...
app.get('/technicians/count-by-professionall', async (req, res) => {
  try {
...
app.get('/technicians/filter', async (req, res) => {
